    ...
    try {
      ...
      if (product) {
        ...
        if (product.additional_images && Array.isArray(product.additional_images)) {
          images.push(...product.additional_images.filter(Boolean))
        }
        ...
        setFormData({
          ...
          era_id: product.era_id?.toString() || "",
                ...
                {formData.images.length > 0 && (
                  <div className="mt-4">
                          ...
                          <div className="absolute top-1 right-1 flex space-x-1">
                            {index > 0 && (
                              <button
                                type="button"
                                onClick={() => {
                                  // Move image up in the array (swap with previous)
                                  const newImages = [...formData.images]
                                  ;[newImages[index], newImages[index - 1]] = [newImages[index - 1], newImages[index]]
                                  setFormData((prev) => ({ ...prev, images: newImages }))
                                }}
                                className="bg-white text-gray-700 rounded-full p-1 opacity-0 group-hover:opacity-100 transition-opacity"
                    ...
                    <p className="text-xs text-gray-500 mt-2">
                      The first image will be used as the main product image. Use the arrow button to reorder images.
                    </p>
                  </div>
                )}
              </div>
